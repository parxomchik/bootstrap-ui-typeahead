...
angular.module('ui.bootstrap.demo').controller('TypeaheadCtrl', function($scope, $http) {
  ...
  $scope.getSelected2 = function (value) {
    $scope.selectedValue2 = value;
  };
  ...
  $scope.getSelected3 = function (value) {
    $scope.selectedValue3 = value;
  };

  $scope.getSelectedType3 = function (value) {
    return $http.get('region-1.json', {
      params: {
        address: value,
        sensor: false
      }
